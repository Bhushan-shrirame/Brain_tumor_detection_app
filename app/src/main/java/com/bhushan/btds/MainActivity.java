...
import com.bhushan.btds.ml.Model;
                ...
                if(img!=null) {
                    ...
                    try {
                        ...
                        if(outputFeature0.getFloatArray()[0]==1.0){
                            output.setText("Yes Image contain Brain Tumor");
                        }
                        else{
                            output.setText("No Image don't have Brain Tumor");
                        }
//                    output.setText(outputFeature0.getFloatArray()[0]+ "\n"+ outputFeature0.getFloatArray()[0]);
                ...
                // If user press the predict button show the message
                else{
    ...
    // To open the image from internal storage or acessing the storage
    @Override
